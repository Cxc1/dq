<template>
  <div class="withdrawMoney">
    ...
    <div class="main">
      <div class="address">
        <p>接收地址</p>
        <p><input type="text" placeholder="请输入..." v-model="puresaDress"></p>
      ...
      <div class="address_label">
        ...
        <p><input type="checkbox" @click="changeBol" :checked="bol"> 添加为常用地址</p>
      </div>
      <p class="min_number" v-show="false">提币金额不能小于300</p>
      <div class="send_number" id="captcha">
        <p>发送数量</p>
        <p>
          <input type="text" maxlength="15" v-model="iptMoney"
                 :placeholder="holder">
        </p>
      </div>
      ...
      <div class="textBox">
        <textarea id="content" name="content" maxlength="20" v-model="remark" placeholder="备注"></textarea>
      </div>
      ...
      getcurrencybywcid() {
        getdataBz('/Wallet/getcurrencybywcid',
          ...
          if (res.data.code == 10000) {
            ...
            this.holder = '可用余额为：' + res.data.result.wuc_money;
  ...
  .main {
    ...
    .submit {
      ...
      > button {
        ...
        font-size: 1.4rem;
        color: #fff;
        background: linear-gradient(to right, #ccc557, #dbb668);
        border: none;
        outline: none;
        border-radius: 2rem;
        &:active {
