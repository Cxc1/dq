  ...
  <div class="withholding">
    ...
    <div class="main">
      <div class="transfer_box">
        <div class="transfer_item" v-if="assAndactShoe && AnTnAShoe">
        ...
        <div class="transfer_item" v-if="AnTnAShoe">
...
<script>
  ...
  export default {
    ...
    created() {
      this.getFee();
      this.assAndactShoe = this.purse == 1 ? false : true;
      this.AnTnAShoe = this.purse == 2 ? false : true;
    }
